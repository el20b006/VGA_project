...
execute()
{
  ...
  irun -V93 -RELAX \
       ...
       glbl.v \
       -sv \
       +incdir+"../../../ipstatic/sarah/OneDrive/Dokumente/FH/5. Sem/CHIP/Froeler_Project/impl/VGA_controller_project/VGA_controller_project.srcs/sources_1/ip/clk_wiz_0/clk_wiz_v5_3_0"
}
