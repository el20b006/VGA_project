...
HD_PWD='C:/Users/sarah/OneDrive/Dokumente/FH/5. Sem/CHIP/Froeler_Project/hw/impl/VGA_controller_project/VGA_controller_project.runs/mc8051_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mc8051_rom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mc8051_rom.tcl
