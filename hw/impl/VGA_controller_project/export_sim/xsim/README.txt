...
#
# Generated by export_simulation on Sun Jan 22 22:27:48 +0100 2023
#
################################################################################
...
switch to the './VGA_ctrl_top_struc_cfg.sh' script.

./VGA_ctrl_top_struc_cfg.sh -reset_run
...
./VGA_ctrl_top_struc_cfg.sh -noclean_files

For more information on the script, please type './VGA_ctrl_top_struc_cfg.sh -help'.
